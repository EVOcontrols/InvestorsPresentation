<template>
  <div class="page" :style="{ backgroundImage: `url(${bg})` }">
    <div class="flex-1 flex flex-col pl-[6.3rem]">
      <div class="">
        <div
          class=" font-bold text-[2.5rem] text-[#759CFF] text-opacity-30 w-[30rem] border-b
            border-[#355188] pt-10">
          Traction
        </div>
      </div>
      <div class="w-[41rem] text-[#BFDFFF] text-[3.75rem] leading-[4.25rem] mb-12">
        <span class="text-[#F9FAFF] font-bold">Market approach</span>
      </div>
      <div class="flex flex-col flex-1 justify-center mb-[20%]">
        <div class="text-2xl text-[#BFDFFF] leading-7 w-[26.25rem] mb-[3.75rem]">
